...
- [seggewiss/json-example](https://github.com/seggewiss/json-example) -  (3 weeks ago)
...
- [shopware/platform](https://github.com/shopware/platform) ([v6.4.15.1](https://github.com/shopware/platform/releases/tag/v6.4.15.1), 4 days ago) - Shopware 6 is an open commerce platform based on Symfony Framework and Vue and supported by a worldwide community and more than 1.500 community extensions
- [opensearch-project/opensearch-php](https://github.com/opensearch-project/opensearch-php) ([2.0.2](https://github.com/opensearch-project/opensearch-php/releases/tag/2.0.2), 1 month ago) - Official PHP Client for OpenSearch
- [shopware/e2e-testsuite-platform](https://github.com/shopware/e2e-testsuite-platform) ([4.0.0](https://github.com/shopware/e2e-testsuite-platform/releases/tag/4.0.0), 3 months ago) - This package contains the e2e platform test suite for Shopware 6 using Cypress
