...
- [seggewiss/simple-food-scanner](https://github.com/seggewiss/simple-food-scanner) -  (1 month ago)
...
- [seggewiss/nvim-config](https://github.com/seggewiss/nvim-config) -  (7 months ago)
