...
- [shopware/jest-preset-sw6-admin](https://github.com/shopware/jest-preset-sw6-admin) ([v6.0.0](https://github.com/shopware/jest-preset-sw6-admin/releases/tag/v6.0.0), 1 day ago) - Jest Test preset for Shopware 6 administration unit tests
- [shopware/acceptance-test-suite](https://github.com/shopware/acceptance-test-suite) ([v11.6.0](https://github.com/shopware/acceptance-test-suite/releases/tag/v11.6.0), 1 day ago) - Acceptance test suite based on Playwright.
