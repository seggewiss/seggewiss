...
- [seggewiss/shadowsmith](https://github.com/seggewiss/shadowsmith) - Forge crypt(3) password hashes for every format /etc/shadow accepts (DES, MD5, SHA-256, SHA-512, Blowfish) — a lab/CTF tool (2 days ago)
