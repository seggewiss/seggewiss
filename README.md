...
- [cakephp/docs](https://github.com/cakephp/docs) - CakePHP CookBook (5 days ago)
...
- [seggewiss/shopware-app-server](https://github.com/seggewiss/shopware-app-server) - A symfony and devenv based shopware env server. (2 weeks ago)
...
- [shopware/shopware](https://github.com/shopware/shopware) ([v6.6.2.0](https://github.com/shopware/shopware/releases/tag/v6.6.2.0), 1 day ago) - Shopware 6 is an open commerce platform based on Symfony Framework and Vue and supported by a worldwide community and more than 1.500 community extensions
- [shopware/meteor](https://github.com/shopware/meteor) ([@shopware-ag/meteor-component-library@3.7.0](https://github.com/shopware/meteor/releases/tag/%40shopware-ag/meteor-component-library%403.7.0), 1 day ago) - Meteor is Shopware’s open-source design system that drives our commerce solutions. Extend and customise every aspect of Shopware – create elegant, delightful, and accessible experiences. There are no limits to your imagination.
- [FriendsOfShopware/shopware-cli](https://github.com/FriendsOfShopware/shopware-cli) ([0.4.42](https://github.com/FriendsOfShopware/shopware-cli/releases/tag/0.4.42), 5 days ago) - CLI for Shopware Account and Shopware 6
