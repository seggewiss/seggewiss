...
- [shopware/shopware](https://github.com/shopware/shopware) ([v6.6.0.0-rc1](https://github.com/shopware/shopware/releases/tag/v6.6.0.0-rc1), 2 days ago) - Shopware 6 is an open commerce platform based on Symfony Framework and Vue and supported by a worldwide community and more than 1.500 community extensions
- [shopware/meteor-admin-sdk](https://github.com/shopware/meteor-admin-sdk) ([3.0.17](https://github.com/shopware/meteor-admin-sdk/releases/tag/3.0.17), 2 days ago) - The meteor-admin-sdk can be used by Shopware 6 apps and plugins. This library allows them to extend the administration with custom functionality.
