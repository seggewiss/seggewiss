...
- [shopware/meteor-icon-kit](https://github.com/shopware/meteor-icon-kit) - An icon library and toolkit that follows a minimal, yet highly expressive style perfectly aligned with Shopware&#39;s product language. (2 days ago)
...
- [shopware/admin-component-library](https://github.com/shopware/admin-component-library) -  (3 weeks ago)
...
- [opensearch-project/opensearch-php](https://github.com/opensearch-project/opensearch-php) ([2.0.1](https://github.com/opensearch-project/opensearch-php/releases/tag/2.0.1), 1 day ago) - Official PHP Client for OpenSearch
- [shopware/e2e-testsuite-platform](https://github.com/shopware/e2e-testsuite-platform) ([4.0.0](https://github.com/shopware/e2e-testsuite-platform/releases/tag/4.0.0), 1 week ago) - This package contains the e2e platform test suite for Shopware 6 using Cypress
