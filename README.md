...
- [shopware/e2e-testsuite-platform](https://github.com/shopware/e2e-testsuite-platform) - This package contains the e2e platform test suite for Shopware 6 using Cypress (2 days ago)
...
- [shopware/eslint-config-base](https://github.com/shopware/eslint-config-base) - Common eslint configuration for several Shopware related projects (4 weeks ago)
...
- [shopware/e2e-testsuite-platform](https://github.com/shopware/e2e-testsuite-platform) ([7.0.1](https://github.com/shopware/e2e-testsuite-platform/releases/tag/7.0.1), 2 days ago) - This package contains the e2e platform test suite for Shopware 6 using Cypress
